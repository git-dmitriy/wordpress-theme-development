...
?>
    ...
    <p>
      ...
      <input type="text" id="<?php echo $this->get_field_id('id-address') ?>" name="<?php echo $this->get_field_name('address'); ?>" value="<?php echo $instance['address']; ?>" class="widefat">
    </p>
  <?php
  }
